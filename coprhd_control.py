...
def login():
    ...
    test = re.search(r'The token is not generated by authentication service.', child.before)
    child.close()
    if test is not None:
	print "CoprHD Login is Incorrect - check coprhd_settings file for Password"
	sys.exit(-1)
